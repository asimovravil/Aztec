...
final class SettingsViewController: UIViewController {
    ...
    private func setupViews() {
        [backgroundView, coinWalletImage, switchNotification,  switchVibration, settingsImage, notificationView, vibrationView, shareAppButton, rateUsButton, privacyPolicyButton].forEach {
            view.addSubview($0)
        }
    }
